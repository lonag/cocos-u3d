...
namespace CocosFramework
{
    ...
    public class CCFileUtils
    {
        ...
        public void LoadAsyncPrefab(string abName, string assetName, Action<UObject[]> func) {
            LoadAsset<GameObject>(abName, new string[] { assetName }, func);
        }

        public void LoadAsyncPrefab(string abName, string[] assetNames, Action<UObject[]> func) {
            LoadAsset<GameObject>(abName, assetNames, func);
        }

        public void LoadAsyncPrefab(string abName, string[] assetNames, LuaFunction func) {
        ...
        /// 载入素材
        /// </summary>
        void LoadAsyncAsset<T>(string abName, string[] assetNames, Action<UObject[]> action = null, LuaFunction func = null) where T : UObject {
        ...
        IEnumerator OnLoadAsyncAssetBundle(string abName, Type type) {
