...
//     {
//         type = t;
//         strType = CocosLuaExport.GetTypeStr(t);                
//         name = CocosLuaExport.ConvertToLibSign(strType);        
//     }
...
// public static class CocosLuaExport 
// {
...
//         {
//             sb.AppendLineEx("\t\tL.RegFunction(\"__tostring\", CocosLua.op_ToString);");
//         }
//     }
...
//             sb.AppendFormat("\t\t\tCocosLua.CheckArgsCount(L, {0});\r\n", count);
//         }
//         else
//         {
...
//         sb.AppendLineEx("\t{");
//         sb.AppendFormat("\t\tCocosLua.PushOut<{0}>(L, new LuaOut<{0}>());\r\n", className);
//         sb.AppendLineEx("\t\treturn 1;");
//         sb.AppendLineEx("\t}");
//     }
...
//         {
//             sb.AppendFormat("{0}object obj = CocosLua.CheckObject(L, {1});\r\n", head, pos);
//         }
//         else
//         {
//             sb.AppendFormat("{0}{1} obj = ({1})CocosLua.CheckObject(L, {2}, typeof({1}));\r\n", head, className, pos);
//         }
//     }
...
//         if (type == typeof(object))
//         {
//             sb.AppendFormat("{0}object obj = CocosLua.ToObject(L, {1});\r\n", head, pos);
//         }
//         else
//         {
//             sb.AppendFormat("{0}{1} obj = ({1})CocosLua.ToObject(L, {2});\r\n", head, className, pos);
//         }
//     }
...
//         {
//             sb.AppendFormat("{0}string {1} = CocosLua.{2}String(L, {3});\r\n", head, arg, checkStr, stackPos);
//         }
...
//         {
//             sb.AppendFormat("{0}LuaFunction {1} = CocosLua.{2}LuaFunction(L, {3});\r\n", head, arg, checkStr, stackPos);
//         }
...
//             if (beCheckTypes)
//             {
//                 sb.AppendFormat("{3} {1} = ({0})CocosLua.ToObject(L, {2});\r\n", str, arg, stackPos, head + "\t");
//             }
//             else
//             {
//                 sb.AppendFormat("{3} {1} = ({0})CocosLua.CheckObject(L, {2}, typeof({0}));\r\n", str, arg, stackPos, head + "\t");
//             }

//             sb.AppendFormat("{0}}}\r\n{0}else\r\n{0}{{\r\n", head);
//             sb.AppendFormat("{0}\tLuaFunction func = CocosLua.CocosLuaFunction(L, {1});\r\n", head, stackPos);             
...
//         {
//             sb.AppendFormat("{0}LuaTable {1} = CocosLua.{2}LuaTable(L, {3});\r\n", head, arg, checkStr, stackPos);
//         }
//         else if (varType == typeof(Vector2))
//         {
//             sb.AppendFormat("{0}UnityEngine.Vector2 {1} = CocosLua.ToVector2(L, {2});\r\n", head, arg, stackPos);
//         }
//         else if (varType == typeof(Vector3))
//         {
//             sb.AppendFormat("{0}UnityEngine.Vector3 {1} = CocosLua.ToVector3(L, {2});\r\n", head, arg, stackPos);
//         }
//         else if (varType == typeof(Vector4))
//         {
//             sb.AppendFormat("{0}UnityEngine.Vector4 {1} = CocosLua.ToVector4(L, {2});\r\n", head, arg, stackPos);
//         }
//         else if (varType == typeof(Quaternion))
//         {
//             sb.AppendFormat("{0}UnityEngine.Quaternion {1} = CocosLua.ToQuaternion(L, {2});\r\n", head, arg, stackPos);
//         }
//         else if (varType == typeof(Color))
//         {
//             sb.AppendFormat("{0}UnityEngine.Color {1} = CocosLua.ToColor(L, {2});\r\n", head, arg, stackPos);
//         }
//         else if (varType == typeof(Ray))
//         {
//             sb.AppendFormat("{0}UnityEngine.Ray {1} = CocosLua.ToRay(L, {2});\r\n", head, arg, stackPos);
//         }
//         else if (varType == typeof(Bounds))
//         {
//             sb.AppendFormat("{0}UnityEngine.Bounds {1} = CocosLua.ToBounds(L, {2});\r\n", head, arg, stackPos);
//         }
//         else if (varType == typeof(LayerMask))
//         {
//             sb.AppendFormat("{0}UnityEngine.LayerMask {1} = CocosLua.ToLayerMask(L, {2});\r\n", head, arg, stackPos);            
//         }
//         else if (varType == typeof(object))
//         {
//             sb.AppendFormat("{0}object {1} = CocosLua.ToVarObject(L, {2});\r\n", head, arg, stackPos);         
//         }
//         else if (varType == typeof(LuaByteBuffer))
//         {
//             sb.AppendFormat("{0}LuaByteBuffer {1} = new LuaByteBuffer(CocosLua.CheckByteBuffer(L, {2}));\r\n", head, arg, stackPos);
//         }
...
//                 if (beParams)
//                 {                    
//                     sb.AppendFormat("{0}{1}[] {2} = CocosLua.{3}(L, {4}, {5});\r\n", head, atstr, arg, fname, stackPos, GetCountStr(stackPos - 1));
//                 }
//                 else
//                 {                    
//                     sb.AppendFormat("{0}{1}[] {2} = CocosLua.{3}(L, {4});\r\n", head, atstr, arg, fname, stackPos);
//                 }
//             }
//         }
...
//             if (beCheckTypes)
//             {
//                 sb.AppendFormat("{0}{1} {2} = ({1})CocosLua.ToObject(L, {3});\r\n", head, str, arg, stackPos);
//             }
//             else if (varType == typeof(UnityEngine.TrackedReference) || typeof(UnityEngine.TrackedReference).IsAssignableFrom(varType))
//             {
//                 sb.AppendFormat("{3}{0} {1} = ({0})CocosLua.CheckTrackedReference(L, {2}, typeof({0}));\r\n", str, arg, stackPos, head);
//             }
//             else if (typeof(UnityEngine.Object).IsAssignableFrom(varType))
//             {
//                 sb.AppendFormat("{3}{0} {1} = ({0})CocosLua.CheckUnityObject(L, {2}, typeof({0}));\r\n", str, arg, stackPos, head);
//             }
//             else if (varType.IsGenericType && varType.GetGenericTypeDefinition() == typeof(Nullable<>))
//             {          
//                 sb.AppendFormat("{0}{1} {2} = ({1})CocosLua.CheckVarObject(L, {3}, typeof({1}));\r\n", head, str, arg, stackPos);
//             }
//             else
//             {
//                 sb.AppendFormat("{0}{1} {2} = ({1})CocosLua.CheckObject(L, {3}, typeof({1}));\r\n", head, str, arg, stackPos);
//             }
//         }
//     }
...
//                 else
//                 {                                      
//                     sb.AppendFormat("{0}{1} obj = ({1})CocosLua.ToObject(L, 1);\r\n", head, className);                    
//                 }
//             }
...
//             sb.AppendFormat("{0}CocosLua.{1}(L, obj);\r\n", head, str);
...
//         {
//             sb.Append(head + "CocosLua.SetBack(L, 1, obj);\r\n");
//         }   
...
//                 sb.AppendFormat("{0}CocosLua.{1}(L, {2});\r\n", head, str, arg);
//             }
//         }
//     }
...
//             BeginTry();
//             sb.AppendLineEx("\t\t\to = CocosLua.ToObject(L, 1);");
...
//         sb.AppendLineEx("\t{");                
//         sb.AppendFormat("\t\tCocosLua.Push(L, new EventObject(\"{0}.{1}\"));\r\n",GetTypeStr(type), varName);
//         sb.AppendLineEx("\t\treturn 1;");
//         sb.AppendLineEx("\t}");
//     }
...
//             if (type.IsValueType)
//             {
//                 sb.AppendLineEx("\t\t\tCocosLua.SetBack(L, 1, obj);");
//             }
//             sb.AppendLineEx("\t\t\treturn 0;");
//             sb.AppendLineEx("\t\t}");
//             sb.AppendLineEx("\t\tcatch(Exception e)");
...
//         if (!isStatic)
//         {
//             sb.AppendFormat("\t\t\t{0} obj = ({0})CocosLua.CheckObject(L, 1, typeof({0}));\r\n", className);
//         }
...
//         sb.AppendLineEx("\t\t\t{");
//         sb.AppendLineEx("\t\t\t\targ0 = (EventObject)CocosLua.ToObject(L, 2);");
//         sb.AppendLineEx("\t\t\t}");
//         sb.AppendLineEx("\t\t\telse");
//         sb.AppendLineEx("\t\t\t{");
...
//     //    sb.AppendLineEx("\t{");
//     //    sb.AppendLineEx("\t\tobject obj = CocosLua.ToObject(L, 1);\r\n");
...
//             if (t == typeof(System.ObsoleteAttribute) || t == typeof(NoCocosLuaAttribute) || t == typeof(MonoPInvokeCallbackAttribute) ||
...
//             sb.AppendFormat("\tstatic int get_{0}(IntPtr L)\r\n", fields[i].Name);
//             sb.AppendLineEx("\t{");
//             sb.AppendFormat("\t\tCocosLua.Push(L, {0}.{1});\r\n", className, fields[i].Name);
//             sb.AppendLineEx("\t\treturn 1;");
//             sb.AppendLineEx("\t}");            
//         }
...
//         sb.AppendLineEx("\t\tCocosLua.Push(L, o);");
//         sb.AppendLineEx("\t\treturn 1;");
//         sb.AppendLineEx("\t}");    
//     }
...
//     {
//         extendName = "CocosLua_" + className.Replace(".", "_");
...
//         sb.AppendLineEx("\t\t{");
//         sb.AppendLineEx("\t\t\tint count = LuaDLL.lua_gettop(L);");
//         sb.AppendLineEx("\t\t\tLuaFunction func = CocosLua.CheckLuaFunction(L, 1);");
//         sb.AppendLineEx();
//         sb.AppendLineEx("\t\t\tif (count == 1)");
//         sb.AppendLineEx("\t\t\t{");
//         sb.AppendFormat("\t\t\t\tDelegate arg1 = DelegateFactory.CreateDelegate(typeof({0}), func);\r\n", GetTypeStr(t));
//         sb.AppendLineEx("\t\t\t\tCocosLua.Push(L, arg1);");
//         sb.AppendLineEx("\t\t\t}");
//         sb.AppendLineEx("\t\t\telse");
//         sb.AppendLineEx("\t\t\t{");
//         sb.AppendLineEx("\t\t\t\tLuaTable self = CocosLua.CheckLuaTable(L, 2);");
//         sb.AppendFormat("\t\t\t\tDelegate arg1 = DelegateFactory.CreateDelegate(typeof({0}), func, self);\r\n", GetTypeStr(t));
//         sb.AppendFormat("\t\t\t\tCocosLua.Push(L, arg1);\r\n");
//         sb.AppendLineEx("\t\t\t}");
